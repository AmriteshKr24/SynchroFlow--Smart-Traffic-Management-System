...
model=YOLO('Main project(Smart Traffic Management System)/best.pt')
...
cap=cv2.VideoCapture('Main project(Smart Traffic Management System)/video3.mp4')


my_file = open("Main project(Smart Traffic Management System)/coco1.txt", "r")
data = my_file.read()
